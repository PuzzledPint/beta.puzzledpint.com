...
RSpec.describe GameControl::PuzzleSetsController, type: :controller do

  # This should return the minimal set of attributes required to create a valid
  # GameControl::PuzzleSet. As you add validations to GameControl::PuzzleSet, be sure to
  ...
  # GameControl::PuzzleSetsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "DELETE #destroy" do
    it "destroys the requested game_control_puzzle_set" do
      puzzle_set = GameControl::PuzzleSet.create! valid_attributes
      expect {
        delete :destroy, params: {id: puzzle_set.to_param}, session: valid_session
      }.to change(GameControl::PuzzleSet, :count).by(-1)
    end

    it "redirects to the game_control_puzzle_sets list" do
      puzzle_set = GameControl::PuzzleSet.create! valid_attributes
      delete :destroy, params: {id: puzzle_set.to_param}, session: valid_session
      expect(response).to redirect_to(game_control_puzzle_sets_url)
    end
  end
